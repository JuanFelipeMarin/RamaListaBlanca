...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoHoraAlimentacion
    {
        public int intPkMovimientoHoraAlimentacion { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkHoraAlimentacion { get; set; }
        public string strAlimentos { get; set; }
        ...
        public virtual tblHoraAlimentacion tblHoraAlimentacion { get; set; }
    }
}
