...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoAntecedentesFamiliares
    {
        public int intPkMovimientoAntecedentesFamiliares { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkAntecedenteFamiliar { get; set; }
        ...
        public virtual tblAntecedentesFamiliares tblAntecedentesFamiliares { get; set; }
