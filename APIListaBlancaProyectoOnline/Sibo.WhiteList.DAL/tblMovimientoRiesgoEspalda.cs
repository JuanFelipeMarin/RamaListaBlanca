...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoRiesgoEspalda
    {
        public int intPkMovimientoRiesgoEspalda { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkRiesgoEspalda { get; set; }
        ...
        public virtual tblRiesgoEspalda tblRiesgoEspalda { get; set; }
    }
}
