...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoMedicamento
    {
        public int intPkMovimientoMedicamento { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkMedicamento { get; set; }
        ...
        public virtual tblMedicamento tblMedicamento { get; set; }
    }
}
