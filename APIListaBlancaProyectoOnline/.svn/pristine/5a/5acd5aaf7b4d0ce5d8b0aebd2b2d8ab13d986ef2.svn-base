...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoDiagnosticos
    {
        public int intPkMovimientoDiagnosticos { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkDiagnostico { get; set; }
        ...
        public virtual tblDiagnosticos tblDiagnosticos { get; set; }
    }
}
