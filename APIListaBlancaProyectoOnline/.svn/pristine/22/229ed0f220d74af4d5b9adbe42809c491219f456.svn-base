...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoAntecedentesPersonales
    {
        public int intPkMovimientoAntecedentesPersonales { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkAntecedentePersonal { get; set; }
