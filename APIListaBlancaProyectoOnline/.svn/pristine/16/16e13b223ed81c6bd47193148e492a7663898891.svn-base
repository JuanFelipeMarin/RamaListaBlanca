...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoAntecedentesDeportivos
    {
        public int intPkMovimientoAntecedentesDeportivos { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkAntecedenteDeportivo { get; set; }
        ...
        public virtual tblAntecedentesDeportivos tblAntecedentesDeportivos { get; set; }
