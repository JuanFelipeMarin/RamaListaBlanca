...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoRiesgoCaderaSuperior
    {
        public int intPkMovimientoRiesgoCaderaSuperior { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkRiesgoCaderaSuperior { get; set; }
        ...
        public virtual tblRiesgoCaderaSuperior tblRiesgoCaderaSuperior { get; set; }
    }
}
