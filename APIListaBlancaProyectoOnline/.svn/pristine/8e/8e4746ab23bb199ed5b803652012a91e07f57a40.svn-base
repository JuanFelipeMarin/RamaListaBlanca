...
namespace Sibo.WhiteList.DAL
{
    ...
    public partial class tblMovimientoPerimetros
    {
        public int intPkMovimientoPerimetros { get; set; }
        public int intFkConsulta { get; set; }
        public int intFkPerimetro { get; set; }
        public double intValor { get; set; }
