...
namespace libComunicacionBioEntry
{
    public class BSSDK
    {
        ...
        [DllImport("BS_SDK.dll",
             CharSet = CharSet.Ansi,
             EntryPoint = "BS_ClearLogCache")]
        public static extern int BS_ClearLogCache(int handle);

        [DllImport("BS_SDK.dll",
     CharSet = CharSet.Ansi,
     EntryPoint = "BS_ClearLogCacheEx")]
        public static extern int BS_ClearLogCacheEx(int handle);

        [DllImport("BS_SDK.dll",
            CharSet = CharSet.Ansi,
            EntryPoint = "BS_ReadLogCache")]
        public static extern int BS_ReadLogCache(int handle, ref int numOflog, IntPtr logRecord);

        [DllImport("BS_SDK.dll",
            CharSet = CharSet.Ansi,
            EntryPoint = "BS_ReadLogCacheEx")]
        public static extern int BS_ReadLogCacheEx(int handle, ref int numOflog, IntPtr logRecord);
        ...
        public static extern int BS_EnrollMultipleUserBEPlus(int handle, int numOfUser, IntPtr BEuserHdr, byte[] templateData);
        ...
        public static extern int BS_DeleteTimeScheduleEx(int handle, int ID);

        [DllImport("BS_SDK.dll",
           CharSet = CharSet.Ansi,
        EntryPoint = "BS_DeleteAccessGroupEx")]
        public static extern int BS_DeleteAccessGroupEx(int handle, int ID);
       ...
       EntryPoint = "BS_SetAllTimeScheduleEx")]
        ...
        // Constants
        //
        public const int NO_TIME_SCHEDULE = 0xFD;
        public const int ALL_TIME_SCHEDULE = 0xFE;
        public const int NUM_OF_DAY = 9;
        public const int NUM_OF_HOLIDAY = 2;
        ...
        public const int HOLIDAY1 = 7;
        public const int HOLIDAY2 = 8;
